...
python main_adv_training.py hydra.run.dir='./results/adv_training/nir/resnext50_32x4d/white_rgb' model.name=resnext50_32x4d +attack_type.name=white dataset.name=rgb_nir train_params.device="$DEVICE"
python main_adv_training.py hydra.run.dir='./results/adv_training/nir/resnext50_32x4d/white_ir' model.name=resnext50_32x4d +attack_type.name=white dataset.name=ir_nir train_params.device="$DEVICE"
